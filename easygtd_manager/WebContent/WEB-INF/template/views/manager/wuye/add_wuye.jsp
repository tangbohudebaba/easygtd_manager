...
<html>
	...
	<div id="friendlink" currentindex=""></div>
		...
		<button type="button" class="btn btn-primary" onClick="to_other_page('wuye/all_wuye.jhtml');">取消</button>
		<button type="button" class="btn btn-primary" onClick="submit_wuye_info();">提交</button>
	</body>
</html>